...
/**
 * The persistence utility for the l m s book1 service. This utility wraps {@link LMSBook1PersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LMSBook1Util {
	 ...
	 */
	public static void clearCache(LMSBook1 lmsBook1) {
		getPersistence().clearCache(lmsBook1);
	}
	 ...
	 */
	public static List<LMSBook1> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<LMSBook1> findWithDynamicQuery(
	 ...
	 */
	public static LMSBook1 update(LMSBook1 lmsBook1) throws SystemException {
		return getPersistence().update(lmsBook1);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static LMSBook1 update(LMSBook1 lmsBook1,
		ServiceContext serviceContext) throws SystemException {
		return getPersistence().update(lmsBook1, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.slayer.model.LMSBook1 lmsBook1) {
		getPersistence().cacheResult(lmsBook1);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.slayer.model.LMSBook1> lmsBook1s) {
		getPersistence().cacheResult(lmsBook1s);
	}
	...
	*/
	public static com.slayer.model.LMSBook1 create(long bookId) {
	...
	*/
	public static com.slayer.model.LMSBook1 remove(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.slayer.NoSuchBook1Exception {
		return getPersistence().remove(bookId);
	}

	public static com.slayer.model.LMSBook1 updateImpl(
		com.slayer.model.LMSBook1 lmsBook1)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(lmsBook1);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.slayer.model.LMSBook1 findByPrimaryKey(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.slayer.NoSuchBook1Exception {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.slayer.model.LMSBook1 fetchByPrimaryKey(long bookId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.slayer.model.LMSBook1> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.slayer.model.LMSBook1> findAll(int start,
	...
	*/
	...
	public static LMSBook1Persistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LMSBook1Persistence)PortletBeanLocatorUtil.locate(com.slayer.service.ClpSerializer.getServletContextName(),
					LMSBook1Persistence.class.getName());

			ReferenceRegistry.registerReference(LMSBook1Util.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LMSBook1Persistence persistence) {
	}

	private static LMSBook1Persistence _persistence;
}